...
procedure TGenFindings.Assign(Src: TPCEItem);
begin
  inherited;

end;

procedure TGenFindings.Clear;
begin
  inherited;

end;

function TGenFindings.DelimitedStr: string;
begin

end;


function TGenFindings.ItemStr: string;
begin

end;

procedure TGenFindings.SetFromString(const x: string);
begin
  inherited;
