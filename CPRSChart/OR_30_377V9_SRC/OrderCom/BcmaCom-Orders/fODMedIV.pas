...
begin
  ...
  with CtrlInits do
  begin
    cboType.ItemIndex := BCMAIVType;
    cboType.OnChange(nil);
  end;
end;
...
var
  x, tempSch, AdminTime, TempOrder, tmpSch, tempIRoute, tempRoute, PreAddFreq: string;
...
begin
  inherited;
    if (cboSchedule.ItemIndex = -1) and (cboSchedule.Text <> '') then
    begin
      infoBox('Please select a valid schedule from the list.',
              //MOB - N/A Code
