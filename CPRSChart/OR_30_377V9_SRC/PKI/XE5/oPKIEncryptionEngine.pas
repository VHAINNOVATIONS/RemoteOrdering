...
begin
  try
    try
      ...
      aChainConfig.HRestrictedRoot := 0;
      aChainConfig.HRestrictedTrust := 0;
      aChainConfig.HRestrictedOther := 0;
      aChainConfig.CAdditionalStore := 0;
      aChainConfig.RghAdditionalStore := 0;
      ...
      if CertGetCertificateChain(aChainEngine, aPCertContext, nil, 0, @aChainPara, CERT_CHAIN_REVOCATION_CHECK_CHAIN, nil, aChainContext) then
