...
uses
  ...
  VA508AccessibilityManager, RichEdit, fDebugReport, CopyMonitor, StrUtils, vcl.ActnList,
  System.SyncObjs;
...
begin
  ...
  begin
    ...
    case Notifications.FollowUp of
      ...
      NF_TERATOGENIC_ORDER             : NextIndex := PageIDToTab(CT_ORDERS);
...
begin
  ...
  SetUserBoundsArray(NoteSplitters, SizeArray);
  frmNotes.LoadUserSettings(SizeArray);
  ...
  //**** Copy/Paste    Notes form changes now being done on Notes form, not here.
(*  SetUserBounds2('frmNotes.ReadOnlyEditMonitor', s1, Dummy, Dummy, Dummy);
  frmNotes.ReadOnlyEditMonitor.Height := HigherOf(s1, 100); *)
end;
...
begin
  ...
  try
    ...
    begin
      ...
      frmNotes.SaveUserSettings(SizeArray);
      Add(StrUserBoundsArray(NoteSplitters, SizeArray));
